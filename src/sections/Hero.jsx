    ...
    >
      ...
      >
        ...
        <h1 className="mt-10 font-palanquin text-8xl max-sm:text-[72px] max-sm:leading-[82px] font-bold">
          <span className="xl:bg-white xl:whitespace-nowrap xl:relative z-10 pr-10">
            The New Arrival
          </span>
          <br />
        ...
        <p className="font-montserrat text-slate-gray text-lg leading-8 mt-6 mb-14 sm:max-w-sm">
          Discover the latest Nike arrivals, blending quality, comfort, and modern design for your active lifestyle.
        </p>
